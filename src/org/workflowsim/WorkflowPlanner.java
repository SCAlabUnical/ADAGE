...
import org.workflowsim.planning.CriticalPathPlanningAlgorithm;
...
public final class WorkflowPlanner extends SimEntity {
    ...
    private List<Datacenter> dcList;
    ...
    public WorkflowPlanner(String name, int schedulers, List<Datacenter> dcList) throws Exception {
        super(name);
    ...
    private void processPlanning() {
        ...
        planner.setDatacenterList(dcList);
        try {
            planner.run();
        } catch (Exception e) {
    ...
    private BasePlanningAlgorithm getPlanningAlgorithm(PlanningAlgorithm name) {
        ...
        switch (name) {
            ...
            case DHEFT:
                ...
                break;
            case CRITICAL_PATH:
            	planner = new CriticalPathPlanningAlgorithm();
            	break;
            default:
                planner = null;
                break;
