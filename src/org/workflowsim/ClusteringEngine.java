...
//		Job job2 = new Job(getJobList().size() + 1, 110);
...
//		job2.setFileList(fileList);
//		job2.setClassType(ClassType.STAGE_IN.value);
...
//		job2.setUserId(getWorkflowEngine().getSchedulerId(1));
