...
public class ReplicaCatalog {
	...
	private static Map<String, List<Integer>> dataPriority;
	...
	public static boolean isPriority(String name, int id) {
		return dataPriority.containsKey(name) && dataPriority.get(name).contains(id);
	}
}
