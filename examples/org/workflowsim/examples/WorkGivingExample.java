...
public class WorkGivingExample {

	private static Logger logger = Loggers.getConsoleLogger("WorkflowSim");
    ...
    protected static WorkflowDatacenter createDatacenter(String name) {
	    ...
	    System.out.println("numberOfPes=" + HostList.getNumberOfPes(hostList));
	...
	protected static void printJobList(List<Job> list) {
	    ...
	    table.row("Job ID", "Task ID", "STATUS", "Data center ID", "VM ID", "Time", "Start Time", "Finish Time", "Depth");
	...
	public static void main(String[] args) {
    	...
    	PrintStream logOut;
    	try {
    		String outputName = String.format("WorkGiving.planning_%s.nodes_%d.bw_%d.file_%s.log",planning,vmNum,bandwidth,daxFile.getName());
    		PrintStream out = new PrintStream("test/" + outputName);
    		logger.attachLogHandler(new TextLogHandler(out, new SimpleLogFormatter()));
        ...
        try {
             ...
             */
            Parameters.SchedulingAlgorithm sch_method = Parameters.SchedulingAlgorithm.WORKGIVING;
