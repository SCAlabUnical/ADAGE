...
public class WorkflowSimBasicExample1 {
	...
	protected static int vmNum = 1;//number of vms;
	protected static String daxPath = "./config/dax/Montage_25.xml";
	protected static double finishTime=500;
        ...
        for (Job job : list) {
            ...
            if (job.getCloudletStatus() == Cloudlet.SUCCESS) {
                ...
                Log.printLine(indent + indent + job.getResourceId() + indent + indent + indent + job.getVmId()
                        + indent + indent + indent + dft.format(job.getActualCPUTime())
                        + indent + indent + dft.format(job.getExecStartTime()) + indent + indent + indent
                        + dft.format(job.getTaskFinishTime()) + indent + indent + indent + job.getDepth());
            }
