...
public class WorkflowSimMultipleClusterExample1 extends WorkflowSimBasicExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
			String daxPath = "C:\\\\Users\\\\Giovanni\\\\eclipse-workspace\\\\WorkflowSim\\\\config\\\\dax\\\\Montage_100.xml";
    ...
    protected static WorkflowDatacenter createDatacenter(String name) {
        ...
        try {
			...
			ClusterRamDiskStorage s2 = new ClusterRamDiskStorage(name, 6200);
            switch (name) {
                case "Datacenter_0":
                    /**
				...
				s2.setBandwidth("Datacenter_1", interBandwidth);
                    break;
                case "Datacenter_1":
                    /**
				...
				s2.setBandwidth("Datacenter_0", interBandwidth);
                    break;
            }
            // The bandwidth within a data center
